...
<body class="h-full font-poppins bg-gray-50">
    <div class="min-h-screen flex flex-col md:flex-row">
        ...
        <!-- Sidebar -->
        <aside id="sidebar"
            class="w-64 bg-green-600 text-white fixed md:relative inset-y-0 left-0 transform -translate-x-full md:translate-x-0 transition-transform duration-300 ease-in-out z-40">
            <div class="p-5 h-full flex flex-col">
                ...
                <nav class="flex-1">
                    <ul class="space-y-2">
                        <li>
                            <a href="#" id="menuDashboard"
                                class="menu-item flex items-center space-x-3 p-3 rounded-lg bg-green-700 font-medium">
                                <i data-lucide="home" class="w-5 h-5"></i>
                                <span>Dashboard</span>
                            </a>
                        </li>
                        <li>
                            <a href="#" id="menuAdministrasi"
                                class="menu-item flex items-center space-x-3 p-3 rounded-lg hover:bg-green-700 transition-colors duration-200">
                ...
                <div class="mt-auto pt-4 border-t border-green-500">
                    <form action="{{ route('logout') }}" method="POST">
                        @csrf
                        <button type="submit"
                            class="w-full flex items-center space-x-3 p-3 rounded-lg hover:bg-red-500 transition-colors duration-200 font-medium">
        ...
        <main class="flex-1 p-4 md:p-6 overflow-x-hidden">
            ...
            <div id="dashboardContent">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
                    ...
                    <div
                        class="bg-white p-6 rounded-xl shadow-lg border-l-4 border-green-500 hover:shadow-md transition-all duration-300 group">
                        <div class="flex justify-between items-start">
                            ...
                            <div
                                class="bg-green-100 p-3 rounded-lg group-hover:bg-green-200 transition-colors duration-300">
                    ...
                    <!-- Card 2: Pasien BPJS -->
                    <div
                        class="bg-white p-6 rounded-xl shadow-lg border-l-4 border-blue-500 hover:shadow-md transition-all duration-300 group">
                        <div class="flex justify-between items-start">
                            <div>
                            ...
                            <div
                                class="bg-blue-100 p-3 rounded-lg group-hover:bg-blue-200 transition-colors duration-300">
                    ...
                    <!-- Card 3: Pasien Umum -->
                    <div
                        class="bg-white p-6 rounded-xl shadow-lg border-l-4 border-purple-500 hover:shadow-md transition-all duration-300 group">
                        <div class="flex justify-between items-start">
                            <div>
                            ...
                            <div
                                class="bg-purple-100 p-3 rounded-lg group-hover:bg-purple-200 transition-colors duration-300">
                ...
                <div class="bg-white rounded-lg shadow overflow-hidden border border-gray-100">
                    ...
                    <div class="step" id="step-1">
                        ...
                        <form id="form-step-1" class="p-5">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="flex flex-wrap gap-4">
                                    <label class="inline-flex items-center">
                                        <input type="radio" name="metode_kunjungan" value="Datang Langsung"
                                            class="h-4 w-4 text-green-600 focus:ring-green-500" checked>
                                        <span class="ml-2 text-gray-700">Datang Langsung</span>
                                    </label>
                                    <label class="inline-flex items-center">
                                        <input type="radio" name="metode_kunjungan" value="Rujukan"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                <div>
                                    <label class="block text-gray-700 text-sm font-medium mb-1">Tanggal
                                        Kunjungan</label>
                            ...
                            <button type="button"
                                class="next-step w-full bg-green-600 hover:bg-green-700 text-white font-medium py-2 px-4 rounded-md transition duration-200">
                    ...
                    <div class="step hidden" id="step-2">
                        ...
                        <form id="form-step-2" class="p-5">
                            <div class="mb-4">
                                <label class="block text-gray-700 text-sm font-medium mb-1">Nomor Kartu BPJS (Jika
                                    Ada)</label>
                            ...
                            <div class="flex justify-between">
                                <button type="button"
                                    class="prev-step bg-gray-200 hover:bg-gray-300 text-gray-800 font-medium py-2 px-4 rounded-md transition duration-200 flex items-center">
                                    <i data-lucide="arrow-left" class="w-4 h-4 mr-2"></i> Kembali
                                </button>
                                <button type="button"
                                    class="next-step bg-green-600 hover:bg-green-700 text-white font-medium py-2 px-4 rounded-md transition duration-200 flex items-center">
                    ...
                    <div class="step hidden" id="step-3">
                        <div class="p-5 border-b border-gray-200">
                            <h2 class="text-xl font-semibold text-gray-800">Pengukuran tanda vital</h2>
                        </div>
                        <form id="form-step-3" class="p-5">
                            ...
                            <div class="mb-6">
                                ...
                                <input type="number" name="denyut_nadi"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500"
                                    placeholder="Masukkan Denyut Nadi" required>
                            </div>

                            <div class="mb-6">
                                <label class="block text-gray-700 text-sm font-medium mb-1">Berat Badan (kg)</label>
                            ...
                            <div class="mb-6">
                                <label class="block text-gray-700 text-sm font-medium mb-1">Tinggi Badan (cm)</label>
                        ...
                        <form id="form-step-4" class="p-5">
                            <div class="mb-4">
                                ...
                                <textarea name="keluhan_utama"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500"
                                    rows="3" placeholder="Jelaskan keluhan utama pasien" required></textarea>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="riwayat_penyakit"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500"
                                    rows="3" placeholder="Masukkan riwayat penyakit" required></textarea>
                            </div>
                            ...
                            <div class="mb-6">
                                ...
                                <textarea name="riwayat_alergi"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500"
                                    rows="3" placeholder="Masukkan riwayat alergi (jika ada)"></textarea>
                            </div>
                    ...
                    <div class="step hidden" id="step-5">
                        ...
                        <div class="p-5">
                            ...
                            <div class="flex justify-between">
                                ...
                                <button type="button" id="submitAdmin"
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function showReview() {
                ...
                const labels = {
                    ...
                    'bb': 'Berat Badan (kg)', // Tambahan berat badan
                    'tb': 'Tinggi Badan (cm)', // Tambahan tinggi badan
            ...
            document.getElementById('submitAdmin').addEventListener('click', function() {
                ...
                submitBtn.innerHTML =
                    '<i data-lucide="loader" class="w-4 h-4 mr-2 animate-spin"></i> Mengirim...';
                ...
                fetch('{{ route('pasien.store') }}', {
                    ...
                    .then(response => response.json()) // langsung parse JSON
                    .then(data => {
                        console.log('Response dari backend:', data);

                        if (data.success) {
                            alert(data.message || 'Data administrasi Berhasil Terkirim Ke Dokter!');
